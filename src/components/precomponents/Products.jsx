    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="flex gap-6 items-center mb-16">
                ...
                <div className="w-[60%]">
                    <h1 className="text-3xl font-semibold text-gray-900 mb-4">Club Drive</h1>
                    ...
                    <motion.button
                        className="px-0 py-3 w-[10rem] flex items-center justify-center bg-[#E7C873] text-white font-semibold rounded-lg shadow-lg transition duration-300 ease-in-out"
            ...
            <div className="w-[40%]">
                ...
                <div className="w-[60%]">
                    <h1 className="text-3xl font-semibold text-gray-900 mb-4">Haven</h1>
                    <p className="text-lg text-gray-600 mb-6">
            ...
            <div className="w-[40%]">
                ...
                <div className="w-[60%]">
                    <h1 className="text-3xl font-semibold text-gray-900 mb-4">Bugatti Residences</h1>
                    <p className="text-lg text-gray-600 mb-6">
